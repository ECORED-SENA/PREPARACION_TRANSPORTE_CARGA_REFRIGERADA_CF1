...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-segundo.color-acento-contenido.mb-4(data-aos="fade")
      h2 Conceptos generales en el transporte de carga refrigerada
    .row.mb-4.justify-content-center.align-items-center
      ...
      .col-12.col-md-8.col-lg-9.mb-lg-5(data-aos="fade-left")
        .col-lg-6.mb-lg-5.mb-3 
          p Identificar conceptos claves de la operación del transporte de carga refrigerada.
        .tarjeta.color-primario.p-2
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0.px-lg-2 Identificar conceptos 
            .col-auto
